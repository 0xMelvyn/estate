            ...
            <div className='flex flex-col lg:flex-row'>
                <div className='lg:px-20'>
                    ...
                    <div className='flex justify-around lg:justify-start'>
                        <p className='mx-10 lg:mx-5 border-2 p-2 border-gray-800'>Voir la fiche</p>
                        <p className='mx-10 lg:mx-5 border-2 p-2 border-gray-800'>Nous contacter</p>
                    </div>
                </div>
                <div className='pt-5 lg:pt-0 lg:w-3/4 flex mx-auto'>
                    <Image className='object-contain' src={app1} width={250} height={250}/>   
                </div>
            </div>
        </section>

        <section className='my-20 lg:my-40 flex'>
            <div className='flex flex-col lg:flex-row justify-around'>
                ...
                <div className='pt-5 lg:pt-0 w-3/4 flex mx-auto'>
